...
let SECP256K1_N_4: UInt32 = UInt32.max
let SECP256K1_N_5: UInt32 = UInt32.max
let SECP256K1_N_6: UInt32 = UInt32.max
let SECP256K1_N_7: UInt32 = UInt32.max
...
let SECP256K1_N_H_4: UInt32 = UInt32.max
let SECP256K1_N_H_5: UInt32 = UInt32.max
let SECP256K1_N_H_6: UInt32 = UInt32.max
...
func secp256k1_scalar_negate(_ r: inout secp256k1_scalar, _ a: secp256k1_scalar) {
    let nonzero:UInt32 = UInt32.max * (secp256k1_scalar_is_zero(a) ? 0 : 1)
...
func secp256k1_scalar_cond_negate(_ r: inout secp256k1_scalar, _ flag: Int) -> Int {
    ...
    let mask:UInt32 = (flag == 0 ? 0 : UInt32.max) //  !flag - 1;
    let nonzero:UInt32 = UInt32(UInt32.max * (!secp256k1_scalar_is_zero(r) ? 1 : 0))
...
fileprivate struct CA {
    ...
    mutating func muladd(_ a: UInt32, _ b: UInt32) {
        ...
        th += (c0 < tl) ? 1 : 0;  /* at most UInt32.max */
    ...
    mutating func muladd2(_ a: UInt32, _ b: UInt32) {
        ...
        th2 += (tl2 < tl) ? 1 : 0;      /* at most UInt32.max */
